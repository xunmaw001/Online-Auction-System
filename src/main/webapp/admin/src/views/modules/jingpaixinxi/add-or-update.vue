  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jingpaibianhao" label="竞拍编号" prop="jingpaibianhao">
              <el-input v-model="ruleForm.jingpaibianhao" 
                placeholder="竞拍编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="起拍价" prop="qipaijia">
          <el-input v-model="ruleForm.qipaijia" 
              placeholder="起拍价" clearable  :readonly="ro.qipaijia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="起拍价" prop="qipaijia">
              <el-input v-model="ruleForm.qipaijia" 
                placeholder="起拍价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="竞拍价格" prop="jingpaijiage">
              <el-input v-model="ruleForm.jingpaijiage" 
                placeholder="竞拍价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="竞拍日期" prop="jingpairiqi">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.jingpairiqi" 
                type="datetime"
                placeholder="竞拍日期">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jingpairiqi" label="竞拍日期" prop="jingpairiqi">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuliang = true;
            continue;
	            	            ...
	            	            if(o=='qipaijia'){
            this.ruleForm.qipaijia = obj[o];
	    this.ro.qipaijia = true;
            continue;
          }
	            	            if(o=='jingpaijiage'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jingpaixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingpaixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
