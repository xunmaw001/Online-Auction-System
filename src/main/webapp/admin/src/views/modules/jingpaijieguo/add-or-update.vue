<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞拍编号" prop="jingpaibianhao">
          <el-input v-model="ruleForm.jingpaibianhao" 
              placeholder="竞拍编号" clearable  :readonly="ro.jingpaibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞拍编号" prop="jingpaibianhao">
              <el-input v-model="ruleForm.jingpaibianhao" 
                placeholder="竞拍编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞拍价格" prop="jingpaijiage">
          <el-input v-model="ruleForm.jingpaijiage" 
              placeholder="竞拍价格" clearable  :readonly="ro.jingpaijiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞拍价格" prop="jingpaijiage">
              <el-input v-model="ruleForm.jingpaijiage" 
                placeholder="竞拍价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞拍日期" prop="jingpairiqi">
          <el-input v-model="ruleForm.jingpairiqi" 
              placeholder="竞拍日期" clearable  :readonly="ro.jingpairiqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞拍日期" prop="jingpairiqi">
              <el-input v-model="ruleForm.jingpairiqi" 
                placeholder="竞拍日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="买家账号" prop="maijiazhanghao">
          <el-input v-model="ruleForm.maijiazhanghao" 
              placeholder="买家账号" clearable  :readonly="ro.maijiazhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="买家账号" prop="maijiazhanghao">
              <el-input v-model="ruleForm.maijiazhanghao" 
                placeholder="买家账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="买家姓名" prop="maijiaxingming">
          <el-input v-model="ruleForm.maijiaxingming" 
              placeholder="买家姓名" clearable  :readonly="ro.maijiaxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="买家姓名" prop="maijiaxingming">
              <el-input v-model="ruleForm.maijiaxingming" 
                placeholder="买家姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="手机号码" prop="shoujihaoma">
              <el-input v-model="ruleForm.shoujihaoma" 
                placeholder="手机号码" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="竞拍结果" prop="jingpaijieguo">
          <el-select v-model="ruleForm.jingpaijieguo" placeholder="请选择竞拍结果">
            <el-option
                v-for="(item,index) in jingpaijieguoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="竞拍结果" prop="jingpaijieguo">
	      <el-input v-model="ruleForm.jingpaijieguo"
                placeholder="竞拍结果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拍卖账号" prop="paimaizhanghao">
          <el-input v-model="ruleForm.paimaizhanghao" 
              placeholder="拍卖账号" clearable  :readonly="ro.paimaizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拍卖账号" prop="paimaizhanghao">
              <el-input v-model="ruleForm.paimaizhanghao" 
                placeholder="拍卖账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='jingpaibianhao'){
            this.ruleForm.jingpaibianhao = obj[o];
	    this.ro.jingpaibianhao = true;
            continue;
          }
	    ...
	    this.ro.shuliang = true;
            continue;
	            	            ...
	            	            if(o=='jingpaijiage'){
            this.ruleForm.jingpaijiage = obj[o];
	    this.ro.jingpaijiage = true;
            continue;
          }
	            	            if(o=='jingpairiqi'){
            this.ruleForm.jingpairiqi = obj[o];
	    this.ro.jingpairiqi = true;
            continue;
          }
	            	            if(o=='maijiazhanghao'){
	    ...
	    this.ro.shoujihaoma = true;
            continue;
	            	            ...
	            	            if(o=='jingpaijieguo'){
            this.ruleForm.jingpaijieguo = obj[o];
	    this.ro.jingpaijieguo = true;
            continue;
          }
	            	            if(o=='paimaizhanghao'){
            this.ruleForm.paimaizhanghao = obj[o];
	    this.ro.paimaizhanghao = true;
            continue;
          }
	            	            if(o=='xingming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                                                          ...
                                                                                                                                                                                          this.jingpaijieguoOptions = "成功,不成功".split(',')
                                                                },
                                                                                                // 多级联动参数
                                                                                                                          info(id) {
      this.$http({
        url: `jingpaijieguo/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jingpaijieguo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingpaijieguoCrossAddOrUpdateFlag = false;
                  this.parent.search();
