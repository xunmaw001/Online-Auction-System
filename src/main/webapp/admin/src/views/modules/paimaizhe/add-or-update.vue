...
export default {
            ...
            ruleForm: {
                	        paimaizhanghao: '',
	                        	        ...
	                        	        shenfenzhenghao: '',
                                                              ...
                                                              rules: {
                  paimaizhanghao: [
                            { required: true, message: '拍卖账号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `paimaizhe/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.paimaizheCrossAddOrUpdateFlag = false;
                  this.parent.search();
