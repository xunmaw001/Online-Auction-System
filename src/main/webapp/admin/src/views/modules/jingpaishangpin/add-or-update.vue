  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                                                                                                                                                          		if(json.paimaizhanghao!=''&&json.paimaizhanghao){
              		this.ruleForm.paimaizhanghao = json.paimaizhanghao
		}
	...
	this.ruleForm.shangpinmiaoshu = this.ruleForm.shangpinmiaoshu.replace(reg,'../../../ssm5yn2l/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jingpaishangpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingpaishangpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
